...
function App() {
  ...
  async function callApi(endpoint: string, data = form) {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold">Whale-Kube Dashboard</h1>
...
<input
  ...
  type="number"
  value={form.numNodes}
  onChange={e => setForm({ ...form, numNodes: Number(e.target.value) })}
/>
<input
  className="border p-2"
  type="number"
